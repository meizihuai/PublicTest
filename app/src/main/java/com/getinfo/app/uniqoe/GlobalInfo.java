...
//全局变量类，存放全局变量,包含app设置以及最新的PhoneInfo等信息
public class GlobalInfo {
    public static String defaultServerUrl="http://111.53.74.132:7062/default.ashx";
    ...
    public static void setScreenRecorder(ScreenRecorder screenRecorder) {
        GlobalInfo.screenRecorder = screenRecorder;
    }
