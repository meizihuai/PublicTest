...
public class GPSHelper {
    ...
    public GPSHelper(Handler handler, Context context) {
...
//            startActivityForResult(intent, 0);
    ...
    public void UploadGPSData(){
        ...
        msg.what = 0;
        Bundle b = new Bundle();
        b.putDouble("lon", mylon);
        b.putDouble("lat", mylat);
        b.putDouble("accuracy", myaccuracy);
        b.putDouble("altitude",myaltitude);
        b.putDouble("speed", myspeed);
        b.putInt("satelliteCount",satelliteCount);
        msg.setData(b);
        handler.sendMessage(msg);
    }
